...
<div class="page-content">
 ...
 <div class="form-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control form-control-lg" placeholder="No département" id="departement" name="departement"  value="{{ $departement }}">
</div>
                                        </div>
                                    ...
                                    <div class="disable_div" id="disableDiv">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control form-control-lg" id="sameAddress" name="sameAddress" placeholder="Ex. 1 Rue de la Gare" value="{{ $company_address }}">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                   <input type="text" class="form-control form-control-lg" id="sameCity" name="sameCity" value="{{ $company_city }}"  placeholder="Ex. villa">
                                                </div>
                                            </div>
                                            <div class="form-group" id="con_department" @if($address_paid2=="France"||$address_paid2=="") style="display: block;" @else style="display:none;" @endif>
                                                <label class="control-label col-md-3">Département (ex. 01) *</label>
                                                <div class="col-md-9">
                                                    <select class="form-control form-control-lg" id="sameDepartment" name="sameDepartment" onkeyup="hello(this.value);">
                                                        <?php
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="tel" class="form-control form-control-lg" id="samePhone" name="samePhone" value="{{ $phone2 }}" placeholder="Entrez votre téléphone">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label col-md-3">Site internet ou page (ex. Facebook, LinkedIn) de l'entreprise/organisation *</label>
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control form-control-lg" id="sameLink" name="sameLink" value="{{ $link2 }}" placeholder="Ex. www.google.fr ou google.fr">
                                                </div>
                                            </div>
                                   </div>     
                                     <!----------------------Third part---------------------->
