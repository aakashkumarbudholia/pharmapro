                ...
                <div class="container-fluid">
                    ...
                    <p class="mb-4">
                        <ul class="page-breadcrumb breadcrumb">
                            <li>
                                <a href="{{ url('admin/cg') }}">Footer Page /</a>
                            </li>
                            <li>
                                <span style="margin-left: 5px;" class="active">{{ $action }}</span>
                            </li>
                        </ul>
                    </p>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">
                                <i class="fa fa-gift" style="margin-right: 5px;"></i>{{ $action }} CG
                            </h6>
                        </div>
                        ...
                        <option value="fr"  <?php if($lang == 'fr') { echo "selected"; }  ?>>FR</option>
                                ...
                                <div class="form-body">
                                    <div class="form-group row">
                                        <label class="control-label col-md-3">CG Title *</label>
                                        <div class="col-md-9">
                                ...
                                <div class="form-group row">
                                        <label class="control-label col-md-3">CG Contant *</label>
                                        <div class="col-md-9">                      
