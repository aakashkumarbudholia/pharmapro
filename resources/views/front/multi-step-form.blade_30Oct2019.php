...
<input type="text" class="form-control form-control-lg name-auto-fill"  id="fname" name="fname" value="{{ $name }}" placeholder="Enter your name (e.g. John)"  >  
</div>
<div class="form-group">
<label class="fName">Surname*</label>
<input type="text" class="form-control form-control-lg"  id="lname" name="lname"  value="{{ $lname }}" placeholder="Enter your surname (e.g. Smith)" >
</div>
<div class="form-group">
...
<label class="fName">Email*</label>
    <input type="email" class="form-control form-control-lg"  id="email" name="email"  value="{{ $email }}" placeholder="Enter your Email" >
</div>
<div class="form-group">
...
<img id="blah" src="../logo/{{ $logo }}" class="img-responsive auto-logo" alt="" style="width:200px;height:200px;margin-top: 10px;"> 
...
<label class="fName">Select a date for the deadline*</label>
        <div class="col-xs-5 date">
            <div class="input-group input-append date" id="datePicker">
                <input type="text" class="form-control  form-control-lg " name="deadlinedate" id="deadlinedate"  value="{{ $deadline }}"   />
...
<div id="step-2" style="display: none;" class="step">
  ...
  @csrf
    ...
    <input type="hidden" name="s2_old_logo" id="s2_old_logo" value="{{ $s2_logo }}">
    <div class="detSection">
      ...
      <div class="form-group">
        <label class="fName">Name *</label>
        <input type="text" class="form-control form-control-lg name-auto-fill-interviewee" id="s2_fname" name="s2_fname" value="{{ $s2_fname }}" placeholder="Enter your name (e.g. John)" required="">  
      </div>

      <div class="form-group">
        <label class="fName">Surname *</label>
        <input type="text" class="form-control form-control-lg" id="s2_surname" name="s2_surname" value="{{ $s2_surname }}" placeholder="Enter your Surname (e.g. John)" required="">  
      </div>

      <div class="form-group">
          <label class="fName">Occupation *</label>
          <input type="text" class="form-control form-control-lg" id="s2_occupation" name="s2_occupation" value="{{ $s2_occupation }}" placeholder="Enter your occupation (e.g. journalist)" required="">
      </div>

      <div class="form-group">
        <label class="fName">Email *</label>
          <input type="email" class="form-control form-control-lg" id="s2_email" name="s2_email" value="{{ $s2_email }}" placeholder="Enter your Email" required="">
      </div>

      <div class="form-group">
          <label class="fName">Tel.</label>
          <input type="tel" class="form-control form-control-lg" id="s2_phone" name="s2_phone" value="{{ $s2_phone }}" placeholder="Enter your Telephone no." >
      </div>
      ...
      <div class="form-group">
        ...
        <input type="file" name="s2_logo" id="s2_logo1">
            ...
            <img id="blah" src="../logo/{{ $s2_logo }}" class="img-responsive auto-logo2" alt="" style="width:200px;height:200px;margin-top: 10px;">
      ...
      <div class="form-group">
        ...
        <textarea type="text" class="form-control form-control-lg" id="s2_notes" name="s2_notes" placeholder="Head scientist by Novartis">{{ $s2_notes }}</textarea>
      </div>

      <div class="form-group">
          <label class="fName">Link to a congress</label>
          <input type="text" class="form-control form-control-lg" id="s2_link_congress" name="s2_link_congress" value="{{ $s2_link_congress }}" placeholder="e.g. about lice" >
      </div>

      <div class="form-group">
        <label class="fName">Link to pictures to download</label>
        <input type="text" class="form-control form-control-lg" id="s2_link_download" name="s2_link_download" value="{{ $s2_link_download }}" placeholder="e.g. links on Flickr or url" >
      </div>

      <div class="form-group">
        <label class="fName">Facebook page</label>
        <input type="text" class="form-control form-control-lg" id="facebook_page" name="facebook_page" value="{{ $facebook_page }}" placeholder="Facebook page" >
      </div>

      <div class="form-group">
        <label class="fName">Twitter page</label>
        <input type="text" class="form-control form-control-lg" id="twitter_page" name="twitter_page" value="{{ $twitter_page }}" placeholder="Twitter page" >
      </div>

      <div class="form-group">
        <label class="fName">LinkedIn page</label>
        <input type="text" class="form-control form-control-lg" id="linkedin_page" name="linkedin_page" value="{{ $linkedin_page }}" placeholder="LinkedIn page" >
      </div>

      <div class="form-group">
        <label class="fName">Instagram page</label>
        <input type="text" class="form-control form-control-lg" id="instagram_page" name="instagram_page" value="{{ $instagram_page }}" placeholder="Instagram page" >
      </div>

      <div class="form-group">
        <label class="fName">Other social media page</label>
        <input type="text" class="form-control form-control-lg" id="other_social_media_page" name="other_social_media_page" value="{{ $other_social_media_page }}" placeholder="Other social media page" >
      </div>
    </div>
  ...
  @csrf
    ...
    <div class="detSection">
      ...
      <div class="form-group">
          ...
          <textarea type="text" class="form-control form-control-lg" id="lead_paragraph" name="lead_paragraph" placeholder="">{{ $lead_paragraph }}</textarea>
      </div>
      <div class="form-group">
          <label class="fName">Note lead paragraph</label>
          <textarea type="text" class="form-control form-control-lg" id="note_lead_paragraph" name="note_lead_paragraph" placeholder="">{{ $note_lead_paragraph }}</textarea>
      </div>
      ...
      <div class="form-group">
          ...
          <textarea type="text" class="form-control form-control-lg" id="s3_que" name="s3_que[1][question]" placeholder="">{{ $question1 }}</textarea>
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
          ...
          <textarea type="text" class="form-control form-control-lg" id="s3_que" name="s3_que[2][question]" placeholder="">{{ $question2 }}</textarea>
      </div>
      <div class="form-group">
      ...
      <!-- <div class="form-group">
          <label class="fName">Email</label>
          <input type="text" id="send_email" name="send_email" value="{{ $s2_email }}" class="form-control form-control-lg valid" >
          
      </div>  -->
      <h3>End interview</h3>
      <div class="form-group">
          <label class="fName">Final text (e.g. date, name interviewer, references)</label>
          <textarea type="text" class="form-control form-control-lg" id="final_text" name="final_text" placeholder="">{{ $final_text }}</textarea>
      </div>
      <div class="form-group">
          <label class="fName">Note final text</label>
          <textarea type="text" class="form-control form-control-lg" id="note_final_text" name="note_final_text" placeholder="">{{ $note_final_text }}</textarea>
      </div>
    </div>
...
<div class="step" id="step-5">
  ...
  <form class="feildForm" runat="server"  action="{{ url($url) }}" name="frmmultistep5" id="frmmultistep5"  method="POST" enctype="multipart/form-data">
  @csrf
...
<div class="step" id="step-6">
  ...
  <form class="feildForm" runat="server"  action="{{ url($url) }}" name="frmmultistep6" id="frmmultistep6"  method="POST" enctype="multipart/form-data">
  @csrf
    ...
    <div class="detSection">
      ...
      ?>
            ...
            <div class="form-group">
                <label class="fName">Note <?php echo $i;?></label>
                <textarea type="text" class="form-control form-control-lg <?php if($login_type != 'admin'){ ?> disabled <?php } ?>" id="s6_note" name="s6_final[<?php echo $i;?>][notes]" placeholder=""  ><?php if(isset($value->notes)){ echo $value->notes; } ?></textarea>
            </div>  
            <div class="form-group">
              <label class="fName">Answer <?php echo $i;?></label>
            ...
            <div class="form-group">
              <label class="fName">Final note, question, precision <?php echo $i;?></label>
              <textarea type="text" class="form-control form-control-lg <?php if($login_type == 'interviewee'){ ?> disabled <?php } ?>" id="s6_notes_pre" name="s6_final[<?php echo $i;?>][notes_precious]" placeholder="" ><?php if(isset($value->notes_precious)){ echo $value->notes_precious; } ?></textarea>
            </div>
            <div class="form-group">
              <label class="fName">Answer to final note, question, precision <?php echo $i;?></label>
              <textarea type="text" class="form-control form-control-lg " id="s6_ans_pre" name="s6_final[<?php echo $i;?>][anwser_precious]" placeholder=""><?php if(isset($value->anwser_precious)){ echo $value->anwser_precious; } ?></textarea>
            </div>
