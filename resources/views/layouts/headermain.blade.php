...
<nav class="navbar navbar-expand justify-content-center justify-content-md-end">
  <ul class="navbar-nav">
    <li class="nav-item">
      <a class="nav-link  <?php if(strpos($url, 'about') !== false) echo 'active';?>" href="{{ url('/about') }}"><i class="icon-multiple-users-silhouette d-block d-md-none"></i><span class="d-none d-md-inline-block">About US</span></a>
    </li>
...
<?php if(empty(session('user_name'))){ ?>
    <li class="nav-item">
      <a class="nav-link" href="{{ url('creer-profil-employeur') }}"><i class="icon-signup d-block d-md-none"></i><span class="d-none d-md-inline-block">Signup</span></a>
    </li>
<?php  } ?>
  </ul>
</nav>
