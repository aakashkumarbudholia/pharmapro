...
?>
    ...
    if(isset($userdata->company_detail)) { 
      ...
      if($nname != ""){ ?>
          <strong class="company-id"><a href="javascript:void(0);" style="white-space: nowrap;font-size: 17px;"><?php echo $userdata->pharmacie?></a></strong>
          <?php } else { ?> 
    ...
    ?>
      ...
      <?php if($user_data->company_detail == "") { ?>
        <strong class="company-id"><a href="javascript:void(0);"  style="white-space: nowrap;font-size: 17px;"><?php echo $user_data->pharmacie ?></a></strong>
        <?php } else { ?>
      ...
      if($login_type == 'pharmapro_teamhub'){
         if(isset($teamhub->first_name)){
          ...
          <div class="user-login-dropdown">
           <ul>
            <li class="dashboard"><a href="{{ url('dashboard') }}">Tableau de bord</a></li>
            <?php 
                  $day = date("d");
                  $month = date("m");
                  $year = date("y");
                ...
                ?>
            <li class="nouvelle"><a href="{{ url('interview') }}/<?php echo $job_id ?>">Nouvelle offre d'emploi</a></li>
            <li class="mon-compte"><a href="{{ url('Teamhubuser_profile') }}">Mon compte</a></li>
            <li class="mon-entreprise"><a href="#">Mon entreprise (adresses)</a></li>
            <li class="gestion"><a href="#">Gestion utilisateurs </a></li>
            <li class="historique"><a href="#">Historique des achats</a></li>
            <li class="se-deconnecter"><a href="{{ url('logout') }}">Se déconnecter</a></li>   
           </ul>         
          </div>
           <?php
         }
    ...
    <div class="user-login-dropdown">
           <ul>
            ...
            $job_id = 'pef'.$day.$month.$year.'a'.$last_id;
                ?>
            <li class="nouvelle"><a href="{{ url('interview') }}/<?php echo $job_id ?>">Nouvelle offre d'emploi</a></li>
            <li class="mon-compte"><a href="{{ url('profile') }}">Mon compte</a></li>
            <?php $editurl = "profile_entreprise/".session('user_id'); ?>
            <li class="mon-entreprise"><a href="{{ url($editurl) }}">Mon entreprise (adresses)</a></li>
            <li class="gestion"><a href="{{ url('pharmpro_teamhub') }}">Gestion utilisateurs </a></li>
            <li class="historique"><a href="{{ url('purchase_history') }}">Historique des achats</a></li>
            <li class="se-deconnecter"><a href="{{ url('logout') }}">Se déconnecter</a></li>   
           </ul>         
          </div>
        </div>
