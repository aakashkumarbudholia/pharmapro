...
?>
    ...
    if(isset($userdata->company_detail)) { 
      ...
      if($nname != ""){ ?>
        <a href="javascript:void(0);" style="color:#FFF !important;text-decoration: none;font-size:17px;line-height: normal;" onclick="showmenu();"><?php echo $userdata->pharmacie?>

        </a>
    <?php } else { ?>

       <a href="javascript:void(0);" style="color:#FFF !important;text-decoration: none;font-size:17px;line-height: normal;" onclick="showmenu();"><?php echo $nname ; ?>
    ...
    ?>
      ...
      <a href="javascript:void(0);" style="color:#FFF !important;text-decoration: none;font-size:17px;line-height: normal;" onclick="showmenu();"><?php echo $user_data->pharmacie ?>

       <?php } else { ?>

        <a href="javascript:void(0);" style="color:#FFF !important;text-decoration: none;font-size:17px;line-height: normal;" onclick="showmenu();"><?php echo $user_data->company_detail ?>
    ...
    <?php if(isset($userdata->first_name)) { ?>
      ...
      <a href="javascript:void(0);" style="color:#FFF !important;text-decoration: none;font-size:16px;" onclick="showmenu();"><?php echo $userdata->first_name.' '.$userdata->last_name ?>

      <i class="fa fa-caret-down" style="display: inline;text-decoration: none;"></i><i class="fa fa-caret-up" style="display: none;"></i></a>
    ...
    <?php
      ...
      if($login_type == 'pharmapro_teamhub'){
         if(isset($teamhub->first_name)){
          ?>
            <a href="javascript:void(0);" style="color:#FFF !important;text-decoration: none;font-size:16px;" onclick="showmenu();"><?php echo $teamhub->first_name.' '.$teamhub->last_name ?> <i class="fa fa-caret-down" style="display: inline;text-decoration: none;"></i><i class="fa fa-caret-up" style="display: none;"></i></a>
            <ul class="dropdown-user" id="usermenu" style="display:none;">
              ...
              <li>
                <a class="logfont nav-link"  style="color:#FFF !important;" href="{{ url('Teamhubuser_profile') }}">Mon compte</a>
              </li>
              <li>
                <a class="logfont nav-link"  style="color:#FFF !important;" href="{{ url('logout') }}">Se déconnecter</a>
              </li>
            </ul> 
      <?php
         }
   ...
   <ul class="dropdown-user" id="usermenu" style="display:none;">
          ...
          <?php 
            ...
            <li>
              <a class="logfont nav-link"  style="color:#FFF !important;" href="{{ url('interview') }}/<?php echo $job_id ?>">{{ __('message.new_interview') }}</a>
               ...
               <li>
                <a class="logfont nav-link"  style="color:#FFF !important;" href="{{ url('profile') }}">Mon compte</a>
              </li>
          ...
          <!-- Add Date:04/05/2022 -->
           <li>
                <a class="logfont nav-link"  style="color:#FFF !important;" href="{{ url('pharmpro_teamhub') }}">Gestion utilisateurs </a>
          </li>

          <li>
              <a class="logfont nav-link"  style="color:#FFF !important;" href="{{ url('purchase_history') }}">Historique des achats</a>
            </li>
