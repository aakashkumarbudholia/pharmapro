...
?>
<a href="<?php echo e(url($url)); ?>"><img src="<?php echo e(asset('logo/Logo1.png')); ?>" style="width:266px !important;height:70px !important;"></a></div>
</div>
...
<nav class="navbar navbar-expand justify-content-center justify-content-md-end">
  <ul class="navbar-nav">
    ...
    <li class="nav-item">
      <a class="nav-link <?php if(strpos($url, 'dashboard') !== false) echo 'active';?>" href="<?php echo e(url('dashboard')); ?>"><i class="icon-shopping-list d-block d-md-none"></i><span class="d-none d-md-inline-block">Dashboard</span></a>
    </li>
    <?php } ?>
    <li class="nav-item">
      <a class="nav-link <?php if(strpos($url, 'support') !== false) echo 'active';?>" href="<?php echo e(url('support')); ?>"><i class="icon-shopping-list d-block d-md-none"></i><span class="d-none d-md-inline-block">Support</span></a>
    </li>
<?php if(!empty(session('user_name')) && session('login_type') != 'interviewee'){ ?>
    <li class="nav-item">
      <a class="nav-link  <?php if(strpos($url, 'interview') !== false) echo 'active';?>" href="<?php echo e(url('interview')); ?>/<?php echo $keys ?>"><i class="icon-manager d-block d-md-none"></i><span class="d-none d-md-inline-block">New interview</span></a>
    </li>
<?php  } ?>
<?php if(!empty(session('user_name')) && session('login_type') != 'admin'){ ?>
    <li class="nav-item">
      <a class="nav-link  <?php if(strpos($url, 'profile') !== false) echo 'active';?>" href="<?php echo e(url('profile')); ?>"><i class="icon-manager d-block d-md-none"></i><span class="d-none d-md-inline-block">My Profile</span></a>
    </li>
<?php  } ?>
<?php if(empty(session('user_name'))){ ?>
    <li class="nav-item">
      <a class="nav-link  <?php if(strpos($url, 'login') !== false) echo 'active';?>" href="<?php echo e(url('login')); ?>"><i class="icon-locked-padlock d-block d-md-none"></i><span class="d-none d-md-inline-block">Login</span></a>
    </li>
<?php  } else { ?>
 <li class="nav-item">
