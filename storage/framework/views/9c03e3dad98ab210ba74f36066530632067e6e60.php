...
<html lang="en">
    ...
    <body class=" login">
        ...
        <div class="logo">
            <a href="#">
                <img src="<?php echo e(asset('logo/Logo1.png')); ?>" alt="" style="width:400px;" /> </a>
        ...
        <div class="content">
            <!-- BEGIN LOGIN FORM -->
            <form class="login-form" name="FrmAdminLogin" id="FrmAdminLogin" action="<?php echo e(url('check_login')); ?>" method="post">
            <?php echo csrf_field(); ?>
            ...
            <form class="forget-form" action="<?php echo e(url('reset_password')); ?>" method="post">
