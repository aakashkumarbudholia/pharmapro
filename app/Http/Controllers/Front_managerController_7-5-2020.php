...
// $url=$google_url."?secret=".$secret."&response=".$recaptcha."&remoteip=".$ip;
	  ...
	  $state = $request->input('state');
		...
		// send email code start
			...
			$subject = "Formulaire offre emploi Pharmaemploi.fr";
...
if($pval == 1111 && $pval1 == 1111 && $pval2 == 1111)
{ 
$ss1 = 11;
}else{
$ss1 = trim($ss,",");
...
if($pval == 1111 && $pval1 == 1111 && $pval2 == 1111 && $profession_val != 1111)
{ 
...
public function getcontact(Request $request)
  {
      ...
      $message1 = $request->input('message');
			...
			$subject = "Formulaire de contact de Pharmaemploi.fr";
                        $to = "xavier.gruffat@gmail.com";
